...
function _login() {
  _login = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(_ref) {
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully', 1200);
          ...
          case 8:
            ...
            (0, _alerts.hideAlert)('failure', "".concat(_context3.t0.reponse.data.message), 1200);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged out successfully', 1200);
              window.setTimeout(function () {
          ...
          case 7:
            ...
            (0, _alerts.hideAlert)('failure', 'Error logging out ! try again ', 1200);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Reset Token Sent to ".concat(email, " ."), 1200);
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 8:
            ...
            (0, _alerts.hideAlert)('failure', 'Error Sending Token ! please try again ', 1200);
...
var stripe = Stripe('pk_test_51KHoFOLRRKMMK7b9MJ7fzWYzapkohdnZk96shxrCt4H2kAurVN9U7dX97AOgMNdWTYMUya3luLEPeJnmT61SHk7o003pYp3ZYE');
