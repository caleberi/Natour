...
})(
  {
      ...
      function (require, module, exports) {
        ...
        function _login() {
          _login = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee3(_ref) {
                  ...
                  while (1) {
                    switch ((_context3.prev = _context3.next)) {
                      ...
                      case 8:
                        ...
                        (0, _alerts.hideAlert)(
                          'failure',
                          ''.concat(_context3.t0.reponse.data.message),
                          1200
                        );
                    ...
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 4:
                        ...
                        if (res.data.status === 'success') {
                          (0, _alerts.showAlert)(
                            'success',
                            'Reset Token Sent to '.concat(email, ' .'),
                            1200
                          );
                          window.setTimeout(function () {
                            location.assign('/');
    ...
    'index.js': [
      function (require, module, exports) {
        ...
        var reviewBtn = document.querySelector('.reviews__add__review');
        var reviewFormContainer = document.querySelector('.review-form'); // const reviewSubmitBtn = document.querySelector('.reviews__add__review');

        var reviewForm = document.querySelector('.review_form__form');
